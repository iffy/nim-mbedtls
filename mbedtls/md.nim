...
const
  ...
  MBEDTLS_MD_MD5* = 0x03.mbedtls_md_type_t
  MBEDTLS_MD_RIPEMD160* = 0x04.mbedtls_md_type_t
  MBEDTLS_MD_SHA1* = 0x05.mbedtls_md_type_t
  MBEDTLS_MD_SHA224* = 0x08.mbedtls_md_type_t
  MBEDTLS_MD_SHA256* = 0x09.mbedtls_md_type_t
  MBEDTLS_MD_SHA384* = 0x0a.mbedtls_md_type_t
  MBEDTLS_MD_SHA512* = 0x0b.mbedtls_md_type_t
  MBEDTLS_MD_SHA3_224* = 0x10.mbedtls_md_type_t
  MBEDTLS_MD_SHA3_256* = 0x11.mbedtls_md_type_t
  MBEDTLS_MD_SHA3_384* = 0x12.mbedtls_md_type_t
  MBEDTLS_MD_SHA3_512* = 0x13.mbedtls_md_type_t
