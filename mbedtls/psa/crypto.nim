...
{.compile: "./mbedtls/csources/library/psa_crypto.c".}
{.compile: "./mbedtls/csources/library/psa_crypto_hash.c".}
...
{.compile: "./mbedtls/generated/psa_crypto_driver_wrappers.c".}
...
type
  ...
  psa_cipher_operation_t* = psa_cipher_operation_s
  psa_aead_operation_t* = psa_aead_operation_s
  psa_key_derivation_operation_t* = psa_key_derivation_s
  psa_sign_hash_interruptible_operation_t* = psa_sign_hash_interruptible_operation_s
  psa_verify_hash_interruptible_operation_t* = psa_verify_hash_interruptible_operation_s

  psa_key_handle_t* = mbedtls_svc_key_id_t

  mbedtls_psa_stats_s* {.bycopy.} = object
  ...
  mbedtls_psa_stats_t* = mbedtls_psa_stats_s
  psa_drv_slot_number_t* = uint64
  psa_pake_role_t* = uint8
  psa_pake_step_t* = uint8
  psa_pake_primitive_type_t* = uint8
  psa_pake_family_t* = uint8
  psa_pake_primitive_t* = uint32
  psa_pake_cipher_suite_t* = psa_pake_cipher_suite_s
  psa_pake_operation_t* = psa_pake_operation_s
  psa_crypto_driver_pake_inputs_t* = psa_crypto_driver_pake_inputs_s
  psa_jpake_computation_stage_t* = psa_jpake_computation_stage_s
  psa_pake_cipher_suite_s* {.bycopy.} = object
  ...
  psa_crypto_driver_pake_inputs_s* {.bycopy.} = object
  ...
  psa_jpake_step_t* = psa_jpake_step
  psa_jpake_state_t* = psa_jpake_state
  psa_jpake_sequence_t* = psa_jpake_sequence
  psa_crypto_driver_pake_step_t* = psa_crypto_driver_pake_step
  psa_jpake_computation_stage_s* {.bycopy.} = object
...
proc psa_interruptible_get_max_ops*(): uint32 {.importc, cdecl.}
...
proc psa_get_key_enrollment_algorithm*(attributes: ptr psa_key_attributes_t): psa_algorithm_t {.
    importc, cdecl.}
proc mbedtls_psa_crypto_free*() {.importc, cdecl.}
